...
AWS_LAMBDA_FUNCTION="i94_entries"
...
aws s3api put-object --bucket $AWS_BUCKET --key $AWS_KEY --body $package_zip


banner "Updating Lambda"
aws lambda update-function-code --function-name $AWS_LAMBDA_FUNCTION --s3-bucket $AWS_BUCKET --s3-key $AWS_KEY
